...
## Emergent capabilites are common
...
and avoid, the potential risks, Al could
...
"As Al gets probably much smarter
...
rise of the robots' in some lowa town
...
Al could generate potentially deadly chemical compounds because 0.5
we are just letting it to do whatever it want to do in a space. That is
a possibility that it's going to find something.
Which is never been thought about, which has never been.
...
* Systemic Safety (forecasting, ML for cyberdefense, cooperative Al)
...
Superintelligent Al could be extremely
persuasive  
