...
RLHF – Reward model = Direct Preference Optimization (DPO)  
...
### RLHF Challenges - Human Challenges

* Selecting representative humans and getting them to provide feedback is 
difficult 
...
* An individual human’s values are difficult to represent with a reward 
function 
...
Policies tend to perform poorly in deployment even if rewards seen   
...
lecture10-prompting-rlhf.pdf

# Lecture 14 - Transformers Part 1

* Hands-on

# Lecture 15 - Transformers Part 2 

* Hands-on

# Lecture 16 - Hugging face
