...
> Every part of ML pipeline we can see bias creeps in.

## Activity

![alt text](image-221.png)

what could have been the prompt of above image?

* Prompt of An Indian ...

* Prompt of an house in ...

![alt text](image-222.png)

## Hands-on - Bias

Please watch the supplement video content for the hands-on  
Please do watch the video, take the code and do it yourself  
These are simple ones, if you have any trouble reach out  
We can also do TA / Live session on the same  

Code: YouTube description & course website